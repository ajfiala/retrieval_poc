...
def upgrade():
    ...
    if 'message' not in tables:
        op.create_table(
            ...
            Column('message_uuid', UUID, nullable=False, unique=True),
            ...
            Column('user_message', String(500), nullable=False, unique=False),
            Column('ai_message', String(500), nullable=False, unique=False),
